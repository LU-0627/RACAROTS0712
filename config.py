...
# RDCAROTS configuration
_C.RDCAROTS = CN()
_C.RDCAROTS.IO_SCHEMA_PATH = "configs/io_schema/synthetic_regime_delay.yaml"
_C.RDCAROTS.TEST_MODE = "frozen"
_C.RDCAROTS.N_INPUTS = 20
_C.RDCAROTS.N_OUTPUTS = 30
_C.RDCAROTS.ENCODER_ARCH = "lstm"

_C.RDCAROTS.PROJECTOR = CN()
_C.RDCAROTS.PROJECTOR.INPUT_DIM = 512
_C.RDCAROTS.PROJECTOR.HIDDEN_DIM = 512
_C.RDCAROTS.PROJECTOR.OUTPUT_DIM = 512

_C.RDCAROTS.DELAYMIX = CN()
_C.RDCAROTS.DELAYMIX.N_REGIMES = 3
_C.RDCAROTS.DELAYMIX.MAX_LAG = 20
_C.RDCAROTS.DELAYMIX.FORGETTING_FACTOR = 0.99
_C.RDCAROTS.DELAYMIX.CP_INIT = "svd"
_C.RDCAROTS.DELAYMIX.CP_MAX_ITER = 200
_C.RDCAROTS.DELAYMIX.CP_TOL = 0.000001
_C.RDCAROTS.DELAYMIX.HANKEL_P = 10
_C.RDCAROTS.DELAYMIX.HANKEL_Q = 10
_C.RDCAROTS.DELAYMIX.STATE_DIM_MAX = 20
_C.RDCAROTS.DELAYMIX.STABILITY_MARGIN = 0.95
_C.RDCAROTS.DELAYMIX.INVERSE_TEMPERATURE = 1.0
_C.RDCAROTS.DELAYMIX.LOW_CONFIDENCE_THRESHOLD = 0.4
_C.RDCAROTS.DELAYMIX.BOOTSTRAP_WINDOWS = 100
_C.RDCAROTS.DELAYMIX.UPDATE_INTERVAL = 500
_C.RDCAROTS.DELAYMIX.UPDATE_SAMPLE_THRESHOLD = 200
_C.RDCAROTS.DELAYMIX.UPDATE_MISMATCH_THRESHOLD = 0.1
_C.RDCAROTS.DELAYMIX.UPDATE_MISMATCH_CONSECUTIVE = 10

_C.RDCAROTS.POSITIVE_AUGMENTOR = CN()
_C.RDCAROTS.POSITIVE_AUGMENTOR.ENABLE = True
_C.RDCAROTS.POSITIVE_AUGMENTOR.NOISE_LEVEL = 0.1

_C.RDCAROTS.NEGATIVE_AUGMENTOR = CN()
_C.RDCAROTS.NEGATIVE_AUGMENTOR.ENABLE = True
_C.RDCAROTS.NEGATIVE_AUGMENTOR.RELATION_BREAK_PROB = 0.33
_C.RDCAROTS.NEGATIVE_AUGMENTOR.DELAY_BREAK_PROB = 0.33
_C.RDCAROTS.NEGATIVE_AUGMENTOR.CROSS_REGIME_PROB = 0.34
_C.RDCAROTS.NEGATIVE_AUGMENTOR.DELAY_SHIFT_RANGE = [-3, 3]

_C.RDCAROTS.LOSS = CN()
_C.RDCAROTS.LOSS.USE_REGIME_WEIGHTING = True

_C.RDCAROTS.SIM_THRESHOLD = 0.5
_C.RDCAROTS.SIM_THRESHOLD_START = 0.5
_C.RDCAROTS.SIM_THRESHOLD_END = 0.9
_C.RDCAROTS.SIM_THRESHOLD_SCHEDULE = True
_C.RDCAROTS.TEMPERATURE = 0.1
...
_C.RDCAROTS.SCORER.LAMBDA_DELAY = 0.3
_C.RDCAROTS.SCORER.LAMBDA_UNCERTAINTY = 0.2


# Synthetic data generation
_C.SYNTHETIC = CN()
_C.SYNTHETIC.N_TRAIN = 10000
_C.SYNTHETIC.N_VAL = 2000
_C.SYNTHETIC.N_TEST = 5000
